...
switch (int_type_id) {                                              \
    ...
    case Type::IntegerTypeID::MAX_INT_ID:                           \
        ERROR("unsupported int type (FundType::ScalarTypedVal)"); \
}

FundType::ScalarTypedVal FundType::ScalarTypedVal::cast_type (Type::IntegerTypeID to_type_id) {
...
FundType::ScalarTypedVal FundType::ScalarTypedVal::pre_op (bool inc) { // Prefix
    FundType::ScalarTypedVal ret = *this;
    int add = inc ? 1 : -1;
    switch (int_type_id) {
        case IntegerType::IntegerTypeID::BOOL:
            ERROR("bool is illegal in dec and inc operators (FundType::ScalarTypedVal)");
        ...
        case IntegerType::IntegerTypeID::MAX_INT_ID:
            ERROR("perform propagate_type (FundType::ScalarTypedVal)");
    }
    return ret;
}
...
FundType::ScalarTypedVal FundType::ScalarTypedVal::operator- () {
    FundType::ScalarTypedVal ret = *this;
    switch (int_type_id) {
        case IntegerType::IntegerTypeID::BOOL:
        case IntegerType::IntegerTypeID::CHAR:
...
uint64_t FundType::ScalarTypedVal::get_abs_val () {
    switch (int_type_id) {
        case IntegerType::IntegerTypeID::BOOL:
            return val.bool_val;
        case IntegerType::IntegerTypeID::CHAR:
    ...
    ERROR("reaching unreachable code (FundType::ScalarTypedVal)");
}

void FundType::ScalarTypedVal::set_abs_val (uint64_t new_val) {
    switch (int_type_id) {
        case IntegerType::IntegerTypeID::BOOL:
...
FundType::ScalarTypedVal FundType::ScalarTypedVal::operator! () {
    FundType::ScalarTypedVal ret = FundType::ScalarTypedVal(Type::IntegerTypeID::BOOL);
    switch (int_type_id) {
        case IntegerType::IntegerTypeID::BOOL:
...
FundType::ScalarTypedVal FundType::ScalarTypedVal::operator+ (ScalarTypedVal rhs) {
    FundType::ScalarTypedVal ret = *this;
...
FundType::ScalarTypedVal FundType::ScalarTypedVal::operator __op__ (ScalarTypedVal rhs) {           \
    FundType::ScalarTypedVal ret = FundType::ScalarTypedVal(Type::IntegerTypeID::BOOL);             \
                                                                                                    \
    switch (int_type_id) {                                                                          \
        case IntegerType::IntegerTypeID::BOOL:                                                      \
...
FundType::ScalarTypedVal FundType::ScalarTypedVal::generate (std::shared_ptr<Context> ctx, FundType::IntegerTypeID _int_type_id) {
    std::shared_ptr<IntegerType> tmp_type = IntegerType::init (_int_type_id);
    FundType::ScalarTypedVal min = tmp_type->get_min();
    FundType::ScalarTypedVal max = tmp_type->get_max();
    return generate(ctx, min, max);
}

FundType::ScalarTypedVal FundType::ScalarTypedVal::generate (std::shared_ptr<Context> ctx, FundType::ScalarTypedVal min, FundType::ScalarTypedVal max) {
    if (min.get_int_type_id() != max.get_int_type_id()) {
        ERROR("int type of min and int type of max are different (FundType::ScalarTypedVal)");
    }
    FundType::ScalarTypedVal ret(min.get_int_type_id());
    switch(min.get_int_type_id()) {
        ...
        case FundType::LLINT:
            ...
            break;
        case FundType::ULLINT:
            gen_rand_typed_val(ret.val.ullint_val, min.val.ullint_val, max.val.ullint_val);
            break;
        case FundType::MAX_INT_ID:
            ERROR("unsupported type of struct member (FundType::ScalarTypedVal)");
            break;
    }
    return ret;
}

std::ostream& yarpgen::operator<< (std::ostream &out, const FundType::ScalarTypedVal &scalar_typed_val) {
...
std::shared_ptr<IntegerType> IntegerType::init (FundType::IntegerTypeID _type_id) {
    std::shared_ptr<IntegerType> ret (nullptr);
    switch (_type_id) {
        case FundType::IntegerTypeID::BOOL:
            ret = std::make_shared<TypeBOOL> (TypeBOOL());
            break;
        case FundType::IntegerTypeID::CHAR:
            ret = std::make_shared<TypeCHAR> (TypeCHAR());
            break;
        case FundType::IntegerTypeID::UCHAR:
            ret = std::make_shared<TypeUCHAR> (TypeUCHAR());
            break;
        case FundType::IntegerTypeID::SHRT:
            ret = std::make_shared<TypeSHRT> (TypeSHRT());
            break;
        case FundType::IntegerTypeID::USHRT:
            ret = std::make_shared<TypeUSHRT> (TypeUSHRT());
            break;
        case FundType::IntegerTypeID::INT:
            ret = std::make_shared<TypeINT> (TypeINT());
            break;
        case FundType::IntegerTypeID::UINT:
            ret = std::make_shared<TypeUINT> (TypeUINT());
            break;
        case FundType::IntegerTypeID::LINT:
            ret = std::make_shared<TypeLINT> (TypeLINT());
            break;
        case FundType::IntegerTypeID::ULINT:
            ret = std::make_shared<TypeULINT> (TypeULINT());
            break;
         case FundType::IntegerTypeID::LLINT:
            ret = std::make_shared<TypeLLINT> (TypeLLINT());
            break;
         case FundType::IntegerTypeID::ULLINT:
...
std::shared_ptr<IntegerType> IntegerType::init (FundType::IntegerTypeID _type_id, Type::CV_Qual _cv_qual, bool _is_static, uint64_t _align) {
...
bool IntegerType::can_repr_value (FundType::IntegerTypeID a, FundType::IntegerTypeID b) {
...
FundType::IntegerTypeID IntegerType::get_corr_unsig (FundType::IntegerTypeID _type_id) {
    // This function is used for different conversion rules, so it can be called only after integral promotion
    switch (_type_id) {
        case INT:
        case UINT:
...
bool BitField::can_fit_in_int (FundType::ScalarTypedVal val, bool is_unsigned) {
