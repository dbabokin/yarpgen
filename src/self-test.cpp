...
/*
    std::shared_ptr<IntegerType> bool_type = IntegerType::init(FundType::IntegerTypeID::BOOL);
    bool_type->dbg_dump();
    std::cout << "\n====================="<< std::endl;

    std::shared_ptr<IntegerType> int_type = IntegerType::init(FundType::IntegerTypeID::INT, FundType::CV_Qual::CONST, true, 32);
    int_type->dbg_dump();
    std::cout << "\n====================="<< std::endl;
    ...
    std::shared_ptr<IntegerType> lint_type = IntegerType::init(FundType::IntegerTypeID::LINT, FundType::CV_Qual::VOLAT, false, 0);
    lint_type->dbg_dump();
    ...
    FundType::ScalarTypedVal char_const_val (Type::IntegerTypeID::CHAR);
    ...
    std::shared_ptr<IntegerType> llint_type = IntegerType::init(FundType::IntegerTypeID::LLINT);
    ...
    FundType::ScalarTypedVal rand_val = FundType::ScalarTypedVal::generate(ctx, Type::IntegerTypeID::SHRT);
...
*/
    ...
    FundType::ScalarTypedVal char_const_val (Type::IntegerTypeID::INT);
